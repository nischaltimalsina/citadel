...
export interface IInputProps
  ...
  customTagRenderer?: (tag: TTag) => React.ReactNode;
...
const TagInput = React.forwardRef<HTMLInputElement, IInputProps>(
  (props, ref) => {
    const {
      id,
      placeholder,
        ...
        {enableAutocomplete ? (
          <div className="w-full">
            <Autocomplete
              tags={tags}
              setTags={setTags}
              autocompleteOptions={filteredAutocompleteOptions as TTag[]}
              maxTags={maxTags}
              onTagAdd={onTagAdd}
