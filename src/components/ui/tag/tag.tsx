...
import { IInputProps, type TTag as TagType } from "./tag-input";
...
export type TagProps = {
  ...
  borderStyle: IInputProps["borderStyle"];
  textCase: IInputProps["textCase"];
  interaction: IInputProps["interaction"];
  animation: IInputProps["animation"];
  textStyle: IInputProps["textStyle"];
  onRemoveTag: (id: string) => void;
} & Pick<IInputProps, "direction" | "onTagClick" | "draggable">;
